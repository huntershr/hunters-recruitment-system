...
function _showInterviewDispatchModal(data, mode) {
    ...
    m.innerHTML =
        ...
        '<div style="padding:20px;">' +
            ...
            (icsBtns ? '<div style="font-size:11px;font-weight:600;color:#1B2A4A;text-transform:uppercase;letter-spacing:0.6px;margin:16px 0 10px;">Calendar Invites</div><div style="display:flex;gap:8px;margin-bottom:14px;">' + icsBtns + '</div>' : '') +
