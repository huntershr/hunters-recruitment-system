...
function jobShareSectionHtml(jobId) {
    ...
    return `<div class="share-icon-row">
        <button onclick="event.stopPropagation();shareJob('linkedin',${jobId})" class="share-icon-btn" style="background:#0A66C2;" title="Share on LinkedIn">${li}</button>
        <button onclick="event.stopPropagation();shareJob('facebook',${jobId})" class="share-icon-btn" style="background:#1877F2;" title="Share on Facebook">${fb}</button>
        <button onclick="event.stopPropagation();shareJob('whatsapp',${jobId})" class="share-icon-btn" style="background:#25D366;" title="Share on WhatsApp">${wa}</button>
