...
function jobShareSectionHtml(jobId) {
    const li = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="4" fill="#5B8DB8"/><path d="M7 9h2v8H7V9zm1-1a1.25 1.25 0 1 1 0-2.5A1.25 1.25 0 0 1 8 8zm3 1h2v1.1c.3-.6 1-1.1 2-1.1 2 0 2.9 1.3 2.9 3.2V17h-2v-4.5c0-1-.3-1.5-1-1.5s-1.5.5-1.5 1.6V17h-2V9z" fill="white"/></svg>`;
    const fb = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="4" fill="#5585D4"/><path d="M13.5 8H15V6h-1.5C12.1 6 11 7.1 11 8.5V10H9.5v2H11v6h2v-6h1.5l.5-2H13v-1.5c0-.3.2-.5.5-.5z" fill="white"/></svg>`;
    const wa = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="4" fill="#48B06A"/><path d="M12 4a8 8 0 0 0-6.93 11.97L4 20l4.17-1.04A8 8 0 1 0 12 4zm4.12 10.88c-.18.5-1.04.95-1.43 1-.37.04-.72.18-2.42-.5-2.04-.83-3.34-2.9-3.44-3.03-.1-.13-.82-1.09-.82-2.08 0-1 .52-1.48.71-1.69.18-.2.4-.25.53-.25h.38c.12 0 .28-.04.44.34.17.4.57 1.38.62 1.48.05.1.08.22.02.35-.06.13-.1.2-.2.32-.1.12-.21.26-.3.35-.1.1-.2.2-.09.4.12.2.52.86 1.12 1.39.77.69 1.42.9 1.62 1 .2.1.32.08.44-.05.12-.13.5-.58.64-.78.13-.2.26-.17.44-.1.18.07 1.15.54 1.35.64.2.1.33.15.38.23.05.09.05.51-.13 1.01z" fill="white"/></svg>`;
